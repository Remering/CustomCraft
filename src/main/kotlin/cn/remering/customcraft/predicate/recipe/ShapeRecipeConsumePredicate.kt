...
class ShapeRecipeConsumePredicate private constructor(
    ...
    companion object: AbstractRecipePredicateBuilder<ShapeRecipeConsumePredicate>(
        ...
        override fun deserialize(predicate: ShapeRecipeConsumePredicate): Map<String, Any> {
            ...
            putKey(map)
            map[PATTERN_PATH] = predicate.pattern
            map[REPLACEMENT_PATH] = predicate.replacement.mapValues { it.value.serialize() }
            return map
        }
